...
;;;;; COPY LINES 028-071 FROM EXAMPLE 10.1 (printnum) ;;;;; ; subroutine to print a number on screen 
...
mov bx, [cs:col_pos] ; use column label
sub word[cs:col_pos], 10
...
; takes the segment, offset, of the thread routine and a parameter ; for the target thread subroutine 
